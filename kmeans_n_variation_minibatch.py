...
if __name__ == "__main__":
    ...
    for i, kmeans_model in enumerate(kmeans_models):
        ...
        joblib.dump(kmeans_model, f"kmeans_model_{kmeans_model.n_clusters}_n3_minibatch.pkl")
        print(f"KMeans model saved as kmeans_model_{kmeans_model.n_clusters}_n3_minibatch.pkl")
    
        kmeans_model = joblib.load(f"kmeans_model_{kmeans_model.n_clusters}_n3_minibatch.pkl")
        print(f"KMeans model loaded from kmeans_model_{kmeans_model.n_clusters}_n3_minibatch.pkl")    
